...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> categories = ["All", "Food", "Travel", "Lifestyle", "Science", "Fashion"];
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Image.asset('assets/images/edit-icon.png', width: screenHeight * 0.04,),
                  SizedBox(
            ...
            Container(
              ...
              margin: EdgeInsets.only(top: screenHeight * 0.001, bottom: screenHeight * 0.001),
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: Text(
                              categories[index],
                            style: TextStyle(
                              fontSize: selectedItem==index ? screenHeight * 0.025 : screenHeight * 0.02 ,
                              color: AppColors.userNameColor,
                              fontWeight: selectedItem==index ? FontWeight.bold : FontWeight.normal
                            ),
                          ),
                      ),
                    ),
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding:  EdgeInsets.only(left: screenWidth * 0.02, right: screenWidth * 0.02),
                            child: CommentTextField(hintText: 'Write a comment', icon: Icons.comment),
                          ),
                          SizedBox(
